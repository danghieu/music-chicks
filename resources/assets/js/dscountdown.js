(function($){
	...
	$.fn.dsCountDown = function(givenOptions){
		...
		var defaults = {
			...
			// Leave blank to use default value or provide a string selector if the lement already exist, Example: .ds-days
					...
					if(running){
						...
						admin_play = true;
							...
							if($("#nowplaying").prop('paused'))
							{
								...
								if($("#nowplaying").prop("currentTime")==0)
									play_song(0);
								else
